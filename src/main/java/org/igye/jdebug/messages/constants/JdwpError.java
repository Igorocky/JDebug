...
public enum JdwpError {
    ...
    ACCESS_DENIED(111, "Debugging has not been enabled in this virtual machine. JVMDI cannot be used."),
    ...
    NATIVE_METHOD(511, "NATIVE_METHOD"),
    INVALID_COUNT(512, "The count is invalid."),
    ;
    private int code;
    private String description;

    JdwpError(int code, String description) {
        this.code = code;
